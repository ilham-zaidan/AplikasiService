...
public class WallpaperChangeService extends Service implements Runnable{
    private int wallpaperId[] = {R.drawable.pict1, R.drawable.pict2};
    private int waktu;
    private int FLAG=0;
    private Thread t;
    ...
    public int onStartCommand (Intent intent, int flag, int startId)
    {
        ...
        Pict1= BitmapFactory.decodeResource(getResources(), wallpaperId[0]);
        Pict2=BitmapFactory.decodeResource(getResources(),wallpaperId[1]);
    ...
    public void run() {
        ...
        try {
            while (true) {
                if (FLAG == 0) {
                    myWallpaper.setBitmap(Pict1);
                    FLAG++;
                } else {
                    myWallpaper.setBitmap(Pict2);
                    FLAG--;
                }
